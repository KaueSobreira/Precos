...
class Produto(models.Model):
    ...
    mlb = models.CharField(max_length=50, blank=True, verbose_name='MLB')
    mlb_vinculado = models.CharField(max_length=50, blank=True, verbose_name='MLB Vinculado')
    ...
    desconto_estrategico = models.BooleanField(default=False, verbose_name='Desconto Estratégico')
